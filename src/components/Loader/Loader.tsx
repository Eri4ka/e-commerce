...
export const Loader: React.FC<LoaderProps> = ({ loading = true, size, className, ...props }): any => {
  return (
    loading && (
      <div className={cl('loader')}>
        <div className={cl(className, size ? `loader_size-${size}` : `loader_size-${LoaderSize.m}`)}>
